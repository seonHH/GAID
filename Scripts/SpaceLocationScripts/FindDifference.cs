    ...
    void Start()
    {
        ...
        switch (answer)
        {
            case 0:
                ...
                img_option_1.transform.localPosition = new Vector3(-img_option_1.transform.localPosition.x, img_option_1.transform.localPosition.y, img_option_1.transform.localPosition.z);
                break;
            case 1:
                img_option_2.transform.Rotate(0, 180, 0);
                img_option_2.transform.localPosition = new Vector3(-img_option_2.transform.localPosition.x, img_option_2.transform.localPosition.y, img_option_2.transform.localPosition.z);
                break;
            case 2:
                img_option_3.transform.Rotate(0, 180, 0);
                img_option_3.transform.localPosition = new Vector3(-img_option_3.transform.localPosition.x, img_option_3.transform.localPosition.y, img_option_3.transform.localPosition.z); break;
        }
